...
class Inside extends State {
	...
	addBeehiveDisplay() {
		...
		this.beehiveDisplay = {
			...
			geleeRoyalProgressBar: new DoubleProgressbar(
				xPosition,
				285,
				50,
				20,
			...
			buildingProgressBar: new DoubleProgressbar(
				xPosition,
				445,
				50,
				20,
	...
	updateBeehiveDisplay(beehive) {
		...
		this.beehiveDisplay.geleeRoyal.text = 'GeleeRoyal: ' + beehive.geleeRoyal;
		this.beehiveDisplay.geleeRoyalProgressBar.update(
			beehive.pollen,
			beehive.honey
		);
		this.beehiveDisplay.buildingProgressBar.update(
			beehive.pollen,
			beehive.honey
		);
